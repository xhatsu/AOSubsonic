      ...
      <div className="p-6 relative z-10">
        ...
        <nav className="space-y-2">
          ...
          <button 
            ...
            className={`flex items-center space-x-3 px-3 py-2 w-full rounded-lg transition-colors text-left ${view === 'playlists' || view === 'playlistDetail' ? 'bg-primary/20 text-primary font-medium' : 'hover:bg-zinc-900 hover:text-white'}`}
          >
